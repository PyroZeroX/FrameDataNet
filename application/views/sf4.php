...
<body>
      ...
      <div class="navbar-inner">
        <div class="container">
            ...
            <div class="headerunit">
                <span class="nav-brand">SF4 Frame Data</span>
            </div>
        </div>
      </div>
    </div>
    <div class="container jPanelMenu-panel">
       <h2>Welcome</h2>
       <p>
        Welcome to the mobile Street Fighter IV Frame Data site, this site was designed for the mobile platform, so for the best viewing experience, please access this site from a mobile device!<br/><br/>
       ...
       <h2>Contact</h2>
       <p>
            This site was created by Steve '<a href="http://www.twitter.com/PyroZeroX">PyroZeroX</a>' Andreou and Shaun '<a href="http://www.twitter.com/KnightKinetik">KnightKinetik</a>' Johnson for Street Fighter IV players around the world.</br></br>
       ...
       <ul>
           <li><a href="http://wiki.shoryuken.com">Shoryuken Wiki</a></li>
       </ul>
    </div> <!-- /container -->
